...
validate_recipe_outputs "aliyun-python-sdk-core-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="aliyun-python-sdk-core-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi